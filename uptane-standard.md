...
If there are no images included in the targets metadata, Targets metadata from the Director repository SHOULD include a vehicle identifier 
in order toavoid a replay attack.
