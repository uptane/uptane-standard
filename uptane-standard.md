...
If there are no images included in the Targets metadata from the Director repository, then the metadata MUST include a vehicle identifier in order to avoid a replay attack.
